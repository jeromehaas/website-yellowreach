  ...
  <div id="opensource" className="section">
    <div className="section__wrapper opensource__wrapper">
      <div className="opensource__box opensource__box--right">
        <img className="opensource__image" src="/animations/sourcecode/sourcecode-full.png" alt="Code" />
        ...
        <img className="opensource__image rotate-backward" src="/animations/sourcecode/sourcecode-ring-outer.png" alt="Code" />
